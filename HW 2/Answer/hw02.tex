...
\begin{enumerate}
	...
	\begin{center}
    	\includegraphics[width=0.6\textwidth]{./Figure/7-2_1.png}
    	\captionof{figure}{Prediction Plots with $\lambda = 10$}
	\end{center}
	\begin{center}
    	\includegraphics[width=0.6\textwidth]{./Figure/7-2_2.png}
    	\captionof{figure}{Prediction Plots with $\lambda = 0.1$}
	\end{center}
	\begin{center}
    	\includegraphics[width=0.6\textwidth]{./Figure/7-2_3.png}
    	\captionof{figure}{Prediction Plots with $\lambda = 1e-5$}
	\end{center}
	\begin{center}
    	\includegraphics[width=0.6\textwidth]{./Figure/7-2_4.png}
